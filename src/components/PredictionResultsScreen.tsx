...
export function PredictionResultsScreen({ raceId, onBack }: PredictionResultsScreenProps) {
  ...
  return (
    <div 
      // 🟢 FIX: Z-Index set to 40. This allows the Modal (z-50) to pop over it correctly without being covered.
    ...
    >
      ...
      <Dialog open={!!selectedDriver} onOpenChange={() => setSelectedDriver(null)}>
        {/* 🟢 FIX: Added 'z-[100]' to ensure this sits ON TOP of the overlay, and 'opacity-100' to prevent transparency */}
